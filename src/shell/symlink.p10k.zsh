# Generated by Powerlevel10k configuration wizard on 2024-09-04 at 11:57 BST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 2750.
# Wizard options: nerdfont-v3 + powerline, large icons, classic, ascii, light, 24h time,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=122
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%249F'  # grey foreground
      local      clean='%76F'   # limegreen foreground
      local   modified='%220F'  # gold foreground
      local  untracked='%213F'  # violet foreground
      local conflicted='%214F'  # orange foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%246F'  # grey foreground
      local      clean='%246F'  # grey foreground
      local   modified='%246F'  # grey foreground
      local  untracked='%246F'  # grey foreground
      local conflicted='%246F'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND=72
  ...
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_FOREGROUND=73
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=78
  # Load color when load is between 50% and 70%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=178
  # Load color when load is over 70%.
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_FOREGROUND=202
  # Custom icon.
  # typeset -g POWERLEVEL9K_LOAD_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_LOAD_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_LOAD_SUFFIX='%% cpu'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=202
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=180
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=180

  # Context format when running with privileges: name (root) on host
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%n (root)%248F on %m'
  # Context format when in SSH without privileges: name on host
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n %248F on %m'
  # Default context format (no privileges, no SSH): name on host
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n %248F on %m'
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=148
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_PREFIX='%248F(py:'
  typeset -g POWERLEVEL9K_VIRTUALENV_SUFFIX='%248F)'
  ...
  #########################[ proxy: system-wide http/https/ftp proxy ]##########################
  # Proxy color.
  typeset -g POWERLEVEL9K_PROXY_FOREGROUND=141
  # Custom icon.
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=73
